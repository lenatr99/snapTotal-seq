...
for line in sample_file:
	...
	filename = 'cells/' + sample + '/split_exon_intron/' + sample + '.exon_barcode_count.txt'
...
count_df.to_csv('snapTotal-seq/Analysis/DICTY_exon_UMI_count_matrix.txt', sep = '\t', index = True, header = True)
